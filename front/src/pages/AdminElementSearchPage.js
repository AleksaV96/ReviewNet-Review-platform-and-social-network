...
import ModeratorReviewElementCard from '../components/layout/cards/ModeratorReviewElementCard';
import MainLayout from '../components/layout/MainLayout';
import Snackbar from '@mui/material/Snackbar';
import MuiAlert from '@mui/material/Alert';


function AdminElementSearchPage(){
    ...
    if(loadedElement.id !== undefined){
        ...
        searchCard =<ModeratorReviewElementCard
...
export default AdminElementSearchPage;